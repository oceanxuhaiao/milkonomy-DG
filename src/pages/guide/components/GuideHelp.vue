  ...
  <el-dialog v-model="visible" title="导购工具使用说明" width="min(900px, 94vw)" append-to-body>
    <div class="guide-help">
      ...
      <section>
        ...
        <dl>
          <dt>买价</dt>
          <dd>优先使用自定义买价；否则使用最近24小时每小时 bid 快照的中位数；没有历史值时使用当前 bid 快照。</dd>
          <dt>卖价</dt>
          <dd>优先使用自定义卖价；否则使用最近24小时每小时 ask 快照的中位数；没有历史值时使用当前 ask 快照。</dd>
          <dt>买/卖价偏差</dt>
          <dd><code>（当前快照价－24小时中位价）÷ 24小时中位价</code>。正数表示当前快照较高，负数表示较低；页面显示值保留一位小数。</dd>
          <dt>历史更新</dt>
      ...
      <section>
        ...
        <dl>
          ...
          <dt>详情</dt>
          <dd>展示1天、3天、5天的成交总量、成交量加权均价、加权中位价、估算买盘/卖盘及最低/最高成交档位。买卖盘属于估算值。</dd>
          <dt>收藏</dt>
